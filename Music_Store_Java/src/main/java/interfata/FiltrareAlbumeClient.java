...
public class FiltrareAlbumeClient extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            try {
                ...
                FiltrareAlbumeClient frame = new FiltrareAlbumeClient(connection);
     ...
     * Create the frame.
     */
    public FiltrareAlbumeClient(Connection connection) {
        ...
        btnNewButton_3.addActionListener(e -> {
            ...
            albumec.setVisible(true); // Afișăm interfața Albume
