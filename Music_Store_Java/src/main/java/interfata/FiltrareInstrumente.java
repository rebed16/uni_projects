...
public class FiltrareInstrumente extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            try {
                ...
                FiltrareInstrumente frame = new FiltrareInstrumente(connection);
     ...
     * Create the frame.
     */
    public FiltrareInstrumente(Connection connection) {
